...
OV12830TRULYB_write_cmos_sensor(0x350b,0x80);
OV12830TRULYB_write_cmos_sensor(0x3602,0x18);
OV12830TRULYB_write_cmos_sensor(0x3612,0x80);
OV12830TRULYB_write_cmos_sensor(0x3620,0x64);//add to reduce temperature
OV12830TRULYB_write_cmos_sensor(0x3621,0xb5);
OV12830TRULYB_write_cmos_sensor(0x3622,0x09);//modify from 0b->09 for reduce temperature 
OV12830TRULYB_write_cmos_sensor(0x3623,0x28);
...
OV12830TRULYB_write_cmos_sensor(0x3701,0x12);
OV12830TRULYB_write_cmos_sensor(0x3702,0x88);
OV12830TRULYB_write_cmos_sensor(0x370b,0xa0);
...
OV12830TRULYB_write_cmos_sensor(0x371f,0x1b);
OV12830TRULYB_write_cmos_sensor(0x3724,0x10);
OV12830TRULYB_write_cmos_sensor(0x3726,0x00);
OV12830TRULYB_write_cmos_sensor(0x372a,0x09);
OV12830TRULYB_write_cmos_sensor(0x3739,0xb0);
OV12830TRULYB_write_cmos_sensor(0x373c,0x40);
...
OV12830TRULYB_write_cmos_sensor(0x3781,0xc8);
OV12830TRULYB_write_cmos_sensor(0x3783,0x31);
OV12830TRULYB_write_cmos_sensor(0x3796,0x84);
...
OV12830TRULYB_write_cmos_sensor(0x4007,0x90);
OV12830TRULYB_write_cmos_sensor(0x4008,0x24);
OV12830TRULYB_write_cmos_sensor(0x404e,0x37);
OV12830TRULYB_write_cmos_sensor(0x404f,0x8f);
OV12830TRULYB_write_cmos_sensor(0x4058,0x40);//add for reduce temperature
OV12830TRULYB_write_cmos_sensor(0x4100,0x2d);
OV12830TRULYB_write_cmos_sensor(0x4101,0x22);
OV12830TRULYB_write_cmos_sensor(0x4102,0x04);
OV12830TRULYB_write_cmos_sensor(0x4104,0x5c);
OV12830TRULYB_write_cmos_sensor(0x4109,0xa3);
OV12830TRULYB_write_cmos_sensor(0x410a,0x03);
...
OV12830TRULYB_write_cmos_sensor(0x484b,0x05);  //SEL_MIPI_CTRL_4B  
...
OV12830TRULYB_write_cmos_sensor(0x4d01,0x19);
OV12830TRULYB_write_cmos_sensor(0x4d02,0xfd);
OV12830TRULYB_write_cmos_sensor(0x4d03,0xd1);
OV12830TRULYB_write_cmos_sensor(0x4d04,0xff);
OV12830TRULYB_write_cmos_sensor(0x4d05,0xff);
OV12830TRULYB_write_cmos_sensor(0x4d07,0x04);  //Temperature monitor
...
OV12830TRULYB_write_cmos_sensor(0x3503,0x07);
OV12830TRULYB_write_cmos_sensor(0x3500,0x00);
OV12830TRULYB_write_cmos_sensor(0x3501,0x97);
OV12830TRULYB_write_cmos_sensor(0x3502,0x00);
OV12830TRULYB_write_cmos_sensor(0x350b,0x80);
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->VideoDelayFrame = 18;
